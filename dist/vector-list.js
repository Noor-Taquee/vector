...
selectAllBtn.addEventListener("click", () => {
    ...
    listEl.querySelectorAll(".vector-btn").forEach(btn => {
...
//#region Functions
function createVectorBtn(vector) {
    ...
    const selectionBtn = createElement("button", { className: "selection-div" }, [createElement("i", { className: "ph-bold ph-circle" })]);
...
//#endregion List
//# sourceMappingURL=vector-list.js.map